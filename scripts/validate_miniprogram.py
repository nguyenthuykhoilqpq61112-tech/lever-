...
def validate_review_copy() -> None:
    review_paths = [
        ROOT / "README.md",
        ROOT / "docs/miniprogram-deployment.md",
        MINIPROGRAM / "README.md",
        MINIPROGRAM / "app.js",
        MINIPROGRAM / "data/leverGaokaoSkill.js",
        MINIPROGRAM / "pages/index/index.wxml",
        MINIPROGRAM / "pages/ai/ai.wxml",
        MINIPROGRAM / "pages/disclaimer/disclaimer.wxml",
    ]
    forbidden_terms = [
        "Lever-GaoKao",
        "Life Leverage",
    ...
    for path in review_paths:
        ...
        for term in forbidden_terms:
            assert term not in text, f"Unexpected app-review-facing term {term!r} in {path.relative_to(ROOT)}"
